  ...
  Widget _navBarWidget() => Padding(
        ...
        child: isCustomWidget!
            ? this.margin!.bottom > 0
                ? SafeArea(
                    top: false,
                    bottom: this.navBarEssentials!.navBarHeight == 0.0 || (this.hideNavigationBar ?? false) ? false : confineToSafeArea ?? true,
                    child: Container(
                ...
                : Container(
                    ...
                    child: SafeArea(
                        top: false,
                        bottom: this.navBarEssentials!.navBarHeight == 0.0 || (this.hideNavigationBar ?? false) ? false : confineToSafeArea ?? true,
                        child: Container(height: this.navBarEssentials!.navBarHeight, child: this.customNavBarWidget)),
                  )
            : this.navBarStyle == NavBarStyle.style15 || this.navBarStyle == NavBarStyle.style15c || this.navBarStyle == NavBarStyle.style16
                ? this.margin!.bottom > 0
                    ? SafeArea(
                        top: false,
                        right: false,
                ...
                : Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: BackdropFilter(
                        filter:
                            this.navBarEssentials!.items![this.navBarEssentials!.selectedIndex!].filter ?? ImageFilter.blur(sigmaX: 3.0, sigmaY: 3.0),
                        child: Container(
                          decoration: getNavBarDecoration(
                            showOpacity: false,
                          ...
                          child: SafeArea(
                            ...
                            left: false,
                            bottom:
                                this.navBarEssentials!.navBarHeight == 0.0 || (this.hideNavigationBar ?? false) ? false : confineToSafeArea ?? true,
                            child: getNavBarStyle()!,
                          ),
                        ),
                      ),
  ...
  Widget? getNavBarStyle() {
    if (isCustomWidget!) {
      ...
      switch (navBarStyle) {
        ...
        case NavBarStyle.style15c:
          return BottomNavStyle15Custom(
            navBarEssentials: this.navBarEssentials,
            navBarDecoration: this.navBarDecoration,
          );
        default:
